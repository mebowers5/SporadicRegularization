# Compare iterated/simulated and modeled tracks
comp_trks <- function(sim_trks, stations, land_barrier, vis_graph, HSgrid, all, multi.grid) {
  ...
  mod_trks <- sf::st_snap(mod_trks, sf::st_centroid(stations$geometry), tolerance = 650) # Snap the linestring centroids to the station point geometry - geometry 'x' is altered
